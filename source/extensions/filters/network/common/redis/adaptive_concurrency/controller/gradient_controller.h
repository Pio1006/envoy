...
#include "source/extensions/filters/network/common/redis/adaptive_concurrency/controller/controller.h"
...
public:
  GradientControllerConfig(
      const envoy::extensions::filters::network::redis_proxy::v3::RedisProxy_GradientControllerConfig&
          proto_config,
