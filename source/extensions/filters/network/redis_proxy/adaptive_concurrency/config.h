...
class AdaptiveConcurrencyFilterFactory
    : public Common::FactoryBase<
          envoy::extensions::filters::network::adaptive_concurrency::v3::AdaptiveConcurrency> {
public:
  AdaptiveConcurrencyFilterFactory() : FactoryBase(NetworkFilterNames::get().AdaptiveConcurrency) {}

  Network::FilterFactoryCb createFilterFactoryFromProtoTyped(
      const envoy::extensions::filters::network::adaptive_concurrency::v3::AdaptiveConcurrency&
          proto_config,
